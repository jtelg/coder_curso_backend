...
//                   title="Agregar producto al carrito" onclick="return addProd_xcarro(${index})">
//                   Agregar al carrito
//               </button>
//               `
//               }
...
//   </div>
// `;
//   if (data.length > 0) document.querySelector("#list_user").innerHTML = html;
// };
